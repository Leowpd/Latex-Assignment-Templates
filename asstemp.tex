...
\question{Basic math examples for convenient copy-pasting}

\subsection{(a)} %Basic multiline equation
\question{Basic multiline equation example.}
...
\question{Sums, limits, integration}
...
\question{Using \textbackslash \texttt{frac} and \textbackslash \texttt{dfrac}.}
...
\section{Graphics}
\question{Pictures and everything so exciting}



\section{Tables}
\question{Yep, tables, as the title would suggest}



\section{Code}
\question{Code code code code code}
...
\question{How to format big chunks of writing}




\section{Bibliography}
\question{Referencing, footnotes, etc}
